        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Student Graphs</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="./pages/studentgraph/semester_gpa.php">SGPA Graph</a></li>
                <li class="nav-item"> <a class="nav-link" href="./pages/studentgraph/prediction_graph.php">Prediction Graph</a></li>
              </ul>
            </div>
          </li>        
