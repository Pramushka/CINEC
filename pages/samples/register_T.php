...
if (isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['reg_no']) && isset($_POST['phone_no'])) {
    ...
    $sql = "INSERT INTO TEACHER (FIRST_NAME, LAST_NAME, EMAIL, Password, REG_NO, PHONE_NO) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $first_name, $last_name, $email, $hashed_password, $reg_no, $phone_no);
...
<head>
    ...
    <title>Marks-Manger Teachers Registration Form</title>
    <!-- plugins:css -->
                ...
                <div class="row flex-grow">
                    <div class="col-lg-6 d-flex align-items-center justify-content-center">
                        <div class="auth-form-transparent text-left p-3">
                            ...
                            <form class="pt-3" action="register_T.php" method="post">
                                ...
                                <div class="text-center mt-4 font-weight-light">
                                    Already have an account? <a href="login_T.php" class="text-primary">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
